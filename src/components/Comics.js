  ...
  return (
    <Container>
      <div className="d-flex justify-content-center" style={{'marginBottom' : 40}}>
        <Link to="/comics/english" className="remove-decoration" style={{marginRight: 20}}><h1 className={`hand-text ${language !== 'english' ? 'inactive-comics' : ''}`}>English Comics</h1></Link>
        <Link to="/comics/arabic" className="remove-decoration" style={{marginLeft: 20}}><h1 className={`hand-text ${language !== 'arabic' ? 'inactive-comics' : ''}`}>Arabic Comics</h1></Link>
      </div>
